...
export const ClientsCard = (props) => {
  ...
  return (
    <Card sx={{
      width: isSmallScreen ? "100%" : (isMediumScreen ? "200px" : isLargeScreen ?"265px" : 217),
      ...
      <CardContent>
        ...
        <Typography  component="div" style={{textAlign:'center',fontSize:'13px',fontWeight:400}}>
        {data.email}
        </Typography>
        <CardActions >
      <Box sx={{width: '50%',
