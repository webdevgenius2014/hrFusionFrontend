...
export const ClientsCard = (props) => {
  ...
  return (
    <Card sx={{ minWidth: '230px',maxWidth:330, borderRadius:3}} >
    ...
    <div>
      ...
      <CardMedia
        ...
        image={`${apiURL}${data.profile_image} `}
        title="green iguana"
      />
      <CardContent>
        ...
        <Button  style={{margin: '5px 0px' }} onClick={()=>{handleNavigate(data.id)}} variant="contained">Profile</Button><br/>
