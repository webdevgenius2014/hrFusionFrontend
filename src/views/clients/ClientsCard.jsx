  ...
  return (
    <Card sx={{ minWidth: '230px',maxWidth:'273px', borderRadius:3}} >
      ...
      <CardContent>
        ...
        <Typography  component="div" style={{textAlign:'center',fontSize:'15px',fontWeight:400}}>
        {data.email}
        </Typography>
        <CardActions >
      <Box sx={{width: '50%',
      ...
      <label style={{fontSize:'18px',fontWeight:700}} >Project</label>
      <h4 style={{margin:'2px', fontSize:'15px',fontWeight:400}}>{data && data?.projects?.length>0 ? (data.projects.length) : '0'}</h4>
      </Box>
      <Box sx={{width: '50%',
      textAlign:'center'}}>
