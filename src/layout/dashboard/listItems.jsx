...
export  const MainListItems = (props) => {
  ...
  switch (userRole) {
    ...
    {i.text !== 'Clients' ?     
    <Tooltip title={!props?.open && i.text}>    
    ...
    id="panel2bh-header"
  >
  <Tooltip title={!props?.open && 'Dropdown'}>  
    <Typography sx={{ color: 'text.secondary',mr: props?.open && 4, my: 0,}}>   
  ...
  {props?.open &&  <Typography sx={{ textAlign:'center', display:'flex',color:location === 'clients'|| location=== 'template'|| location==='Projects' ? '#5D87FF' : '#B1B1B1',justifyContent:'center' }}>
      Clients
    </Typography> }
   
  </AccordionSummary>
  <AccordionDetails sx={{margin:0,padding:!props?.open && '0px !important'}}>
  <Tooltip title={!props?.open && 'Clients'}>  
...
<ListItemText style={{color:location === 'clients' ? '#5D87FF' : '#B1B1B1'}} primary="Listing Clients" />
      ...
      <Tooltip title={!props?.open && 'Template'}>  
  <ListItemButton component={NavLink} to="/template">
     ...
     <ListItemText style={{color:location === 'template' ? '#5D87FF' : '#B1B1B1'}} primary="Template" />
      ...
      <Tooltip title={!props?.open && 'Projects'}>  
  ...
  return (
    <Box sx={{ height: "calc(100vh - 100px)", overflowY: "auto" , overflowX:'hidden'}}>
  {display}
</Box>
  );
};
